...
CREATE TABLE `Category` (
    ...
    `storeId` VARCHAR(191) NOT NULL DEFAULT '1',
...
CREATE TABLE `Order` (
    ...
    `recipientAddress` LONGTEXT NOT NULL,
    `recipientCity` VARCHAR(191) NOT NULL DEFAULT '',
    `recipientNotes` LONGTEXT NOT NULL,
...
CREATE TABLE `Customer` (
    ...
    `deliveryZoneId` VARCHAR(191) NULL,
    `deliveryZoneName` VARCHAR(191) NULL,
    `savedRecipients` LONGTEXT NOT NULL,
    `createdAt` VARCHAR(191) NOT NULL DEFAULT '',
    `updatedAt` VARCHAR(191) NOT NULL DEFAULT '',
...
CREATE TABLE `SiteConfig` (
    ...
    `horarioSectionDesc` LONGTEXT NOT NULL,
    ...
    `howItWorksSteps` LONGTEXT NOT NULL,
    `createdAt` VARCHAR(191) NOT NULL DEFAULT '',
    `updatedAt` VARCHAR(191) NOT NULL DEFAULT '',
